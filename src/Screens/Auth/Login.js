                ...
                <View style={{ flex: 1, alignItems: 'center' }}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        ...
                        <View
                            ...
                            <TouchableOpacity onPress={() => this.props.navigation.navigate("ForgotPassword")} style={styles.forgotPassView}>
                                <Text style={{ color: Colors.Teal2 }}>Hai dimenticato la password?</Text>
                            </TouchableOpacity>
