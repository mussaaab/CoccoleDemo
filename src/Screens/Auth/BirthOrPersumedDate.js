                ...
                <View style={{ flex: 1 }}>
                    <View style={styles.titleView}>
                        <Text style={styles.title}>
                            ...
                            o presunta data del parto
                    </Text>
                    </View>

                    <View style={styles.textView}>
                        <Text style={{ textAlign: 'center' }}>Inserici la data del bambino a cui vuoi dedicare il Diario. Servirà per seguire le tappe fondamentali della sua crescita.</Text>
                    </View>
