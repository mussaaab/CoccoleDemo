        ...
        <View style={{ flex: 1 }}>
          ...
          <View style={styles.textView}>
            <Text style={{ textAlign: 'center' }}>
              È questa la data di nascita o presunto parto del bambino a cui
              vuoi dedicare il Diario? Hai inserito questa data durante la fase
              di registrazione al Club Pampers:
            </Text>
          </View>
